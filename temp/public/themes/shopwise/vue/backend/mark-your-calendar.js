...
(function($) {
    ...
    $.fn.markyourcalendar = function(opts) {
        ...
        this.getAvailableTimes = function() {
            ...
            for (i = 0; i < 7; i++) {
                ...
                $.each(settings.availability[i], function() {
                    tmpAvailTimes += `
                        <a href="javascript:;"  name="selectedTimes[]" v-model="selectedTime" class="myc-available-time" data-time="` + this + `" data-date="` + formatDate(settings.startDate.addDays(i)) + `">
                            ` + this + `
                        </a>
                    `;
                });
        ...
        this.initialize = function() {
            settings.selectedDates.push('2022-11-05 9:00');
            console.log(settings.selectedDates);
            // console.log('intialaize ')
            // render();
        }
