$(function () {
	...
	if(language !== '' && (language === 'en' || language === 'tr') || language === 'en' || language === 'tr'){
		language = false;
	}else{
		language = true;
	}
	...
	var templateOption = {
        ...
        icon = {
            url: "/storage/general/yakut-logo-01-1.png", // url
        ...
        // Google map options
		googleMapOption = {
			latitude: 41.01659868448361,
			longitude: 28.949399200129204,
			zoom: 13,
			marker: [
				['Yaqut', 41.01659868448361, 28.949399200129204, 1, icon]
			]
		},
