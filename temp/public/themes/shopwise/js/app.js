...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      response: [],
      thisweek: [{
        e_name: this.addDays(0),
        a_name: this.arabic(this.addDays(0))
      }, {
        e_name: this.addDays(1),
        a_name: this.arabic(this.addDays(1))
      }, {
        e_name: this.addDays(2),
        a_name: this.arabic(this.addDays(2))
      }, {
        e_name: this.addDays(3),
        a_name: this.arabic(this.addDays(3))
      } // {e_name: this.addDays(4), a_name: this.arabic(this.addDays(4))},
      // {e_name: this.addDays(5), a_name: this.arabic(this.addDays(5))},
      // {e_name: this.addDays(6), a_name: this.arabic(this.addDays(6))},
      ],
      formData: {
        doctor: "",
        service: "",
  ...
  methods: {
    ...
    reset: function reset() {
      ...
      location.href = "/"; // for(let field in this.formData){
    ...
    getDoctorAppointmentList: function getDoctorAppointmentList(id) {
      ...
      axios.get("ajax/doctor-appointment-list", {
        ...
        _this5.availableTime = res.data.data ? res.data.data : [];
      })["catch"](function (res) {});
    },
    ...
    getDayAppointmentList: function getDayAppointmentList(day) {
      ...
      axios.get("ajax/day-appointment-list", {
        ...
        _this6.dayAppointmentList = res.data.data ? res.data.data : [];
      })["catch"](function (res) {});
    }
  }
});
...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "tab-content",
        { attrs: { title: "العيادة / الطبيب", selected: true } },
        [
          _c("div", { staticClass: "form-group" }, [
            _c("label", { attrs: { for: "clinic" } }, [_vm._v("العيادة")]),
            _vm._v(" "),
            _c(
              "select",
              {
          ...
          _vm._v(" "),
          _c("div", { staticClass: "form-group" }, [
            _c("label", { attrs: { for: "doctor" } }, [_vm._v("الطبيب")]),
            _vm._v(" "),
            _c(
              "select",
              {
          ...
          _vm._v(" "),
          _c("div", { staticClass: "form-group" }, [
            _c("label", { attrs: { for: "service" } }, [_vm._v("الخدمة")]),
            _vm._v(" "),
            _c(
              "select",
              {
      ...
      _vm._v(" "),
      _c("tab-content", { attrs: { title: "التاريخ / الوقت" } }, [
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "date" } }, [_vm._v(" اختر اليوم")]),
          _vm._v(" "),
          _c(
            "select",
            {
        ...
        _vm._v(" "),
        _vm.dayAppointmentList.length == 0 && this.formData.date
          ? _c("p", { staticClass: "danger" }, [
              _vm._v("يرجى اختيار يوم آخر لا يوجد مواعيد متوفرة في هذا اليوم"),
            ])
          : _vm._e(),
        _vm._v(" "),
      ...
      _vm._v(" "),
      _c("tab-content", { attrs: { title: "المعلومات الشخصية" } }, [
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "name" } }, [
            _vm._v(_vm._s(_vm.__("الاسم"))),
          ]),
          _vm._v(" "),
          _c("input", {
            directives: [
            ...
            attrs: { type: "text", placeholder: "أدخل الاسم" },
        ...
        _c("div", { staticClass: "form-group" }, [
          ...
          _c("input", {
            ...
            attrs: { type: "text", placeholder: "أدخل الهاتف" },
      ...
      _vm._v(" "),
      _c("tab-content", { attrs: { title: "حجز الموعد" } }, [
        _vm.success
          ? _c("div", [
              _c("p", { staticClass: "success" }, [
                _vm._v("لقد تم حجز الموعد بنجاح"),
              ]),
              _vm._v(" "),
              _c("p", { staticClass: "success" }, [
                _vm._v(
                  "ملاحظة: الموعد المحجوز هو توقيت وصلولكم لغرفة الانتظار, وليس وقت دخولكم لعند الطبيب"
                ),
              ]),
              _vm._v(" "),
              _c("p", { staticClass: "success" }, [
                _vm._v("شكراً لكم, نتمنا لكم دوام الصحة والعافية"),
              ]),
            ])
          : _vm._e(),
        _vm._v(" "),
        _vm.error
          ? _c("p", { staticClass: "danger" }, [
              _vm._v("يبدو أن هناك خطأ ما يرجى المحاولة لاحقاً"),
            ])
          : _vm._e(),
        _vm._v(" "),
        _c("div", { staticClass: "form-group form-check" }, [
          ...
          _c("label", { staticClass: "form-check-label" }, [
            _vm._v("أؤكد انني اريد حجز هذا الموعد"),
          ]),
          _vm._v(" "),
          _vm.hasError("terms")
            ? _c("div", { staticClass: "invalid-feedback" }, [
